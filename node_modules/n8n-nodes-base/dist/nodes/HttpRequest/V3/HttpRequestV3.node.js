...
const buffer_decoding_1 = require("./utils/buffer-decoding");
...
class HttpRequestV3 {
    ...
    async execute() {
        ...
        const requests = [];
        const updadeQueryParameter = (0, GenericFunctions_1.updadeQueryParameterConfig)(nodeVersion);
                    ...
                    if (autoDetectResponseFormat) {
                        if (responseContentType.includes('application/json')) {
                            ...
                            if (!response.__bodyResolved) {
                                ...
                                const data = await (0, buffer_decoding_1.binaryToStringWithEncodingDetection)(response.body, responseContentType, this.helpers);
